...
<img display="inline-block" padding-right="30px" alt="c sharp icon" width="42px" src="/img/c-sharp.png"/>   <img display="inline-block" alt="netcore icon" width="42px" src="/img/net-core.png"/>   <img display="inline-block" alt="sql server icon" width="42px" src="/img/sql-server.png"/>    <img display="inline-block" alt="html icon" width="42px" src="/img/html.png"/>   <img display="inline-block" alt="css3 icon" width="42px" src="/img/css-3.png"/>
<br>
<hr>
